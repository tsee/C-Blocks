package C::Blocks::XSWrapper::Parser;
# TODO if/once there's a C function signature parser implemented using Perl's
# lexer & keyword API, this whole thing can be removed again.
use strict;
use warnings;
...
C::Blocks::XSWrapper::Parser - C function signature parsing with regexes

=head1 SYNOPSIS

  my $result = C::Blocks::XSWrapper::Parser::extract_function_metadata($code);

  # This will only parse the first declaration that's found
  my $result = C::Blocks::XSWrapper::Parser::extract_function_metadata($code, {first_only => 1});

=head1 DESCRIPTION

This is internal to C<C::Blocks>.
...
Copyright (c) 2013, 2017, Steffen Mueller.
